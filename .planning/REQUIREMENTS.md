...
- [x] **ADMN-01**: Dashboard page uses indigo StatCard icons, no decorative blobs, rounded-md hero buttons, focus-visible:ring
- [x] **ADMN-02**: Inbound and Outbound list pages use amber (not yellow) and indigo (not blue/purple) status tabs
